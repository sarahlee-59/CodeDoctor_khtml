...
import { getDB, type Product, type DB, countByBenefitType } from "@/lib/db"
      ...
      <div className="office-header border-b office-border bg-white">
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="flex flex-col space-y-4 mb-4">
            ...
            <div className="flex items-center space-x-8 text-sm border-b pb-2">
              <Button variant="link" className="text-blue-600 font-medium px-0">
                전체 <span>({products.length})</span>
              </Button>
              <Button variant="link" className="text-gray-500 px-0">
                가격비교 <span>({countByBenefitType(products, '온누리상품권')})</span>
              </Button>
              <Button variant="link" className="text-gray-500 px-0">
                컵셀 상품 <span>({countByBenefitType(products, '컵셀')})</span>
              </Button>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <select className="office-input w-20" value="40" onChange={() => {}}>
              <option>40개</option>
              <option>20개</option>
              <option>60개</option>
            </select>
